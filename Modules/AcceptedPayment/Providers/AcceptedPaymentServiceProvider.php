...
use Modules\AcceptedPayment\Repositories\AcceptedPaymentEntityRepository as AcceptedPaymentEntityRepositoryMaster;

/**
 * En: Service provider of the module.
 * Es: Proveedor de servicios del módulo.
 *
 * @package AcceptedPaymentServiceProvider
 */
class AcceptedPaymentServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected string $moduleName = 'AcceptedPayment';

    /**
     * @var string $moduleNameLower
     */
    protected string $moduleNameLower = 'acceptedPayment';
    ...
    public array $bindings = [
        AcceptedPaymentEntityRepository::class => AcceptedPaymentEntityRepositoryMaster::class
    ];
