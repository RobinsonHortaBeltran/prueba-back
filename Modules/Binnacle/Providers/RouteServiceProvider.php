 ...
 *
 * @package Modules\Binnacle\Providers
 */
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected string $moduleNamespace = 'Modules\Binnacle\Http\Controllers';
    ...
    protected function mapWebRoutes(): void
    {
        Route::middleware('web')
            ...
            ->group(module_path('Binnacle', '/Routes/web.php'));
    }
    ...
    protected function mapApiRoutes(): void
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->moduleNamespace)
            ->group(module_path('Binnacle', '/Routes/api.php'));
    }
}
